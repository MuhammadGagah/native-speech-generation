...
""")
					...
					message = _(
						"Dependency installation failed. The Native Speech Generation add-on might not work correctly. Please review the log for errors.",
					)
	...
	def confirm_install():
		...
		res = wx.MessageBox(
			_(
				"Required libraries for Native Speech Generation are missing. "
